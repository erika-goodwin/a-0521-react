...
const exerciseOne = () => {
  // ======== Exercise 1.1 ========
  // Instructions:
  // • Hover over red squigglies to inspect the TS errors. -> asking to be number
  // • Hover over variables to inspect their types. -> pi is now string
  // • Fix the error on line 18 by changing the value of pi to the expected type. -> fixed as number
  ...
  // ======== Exercise 1.2 ========
  // Instructions:
  // • Inspect type of `pie` -> type is now ANY
  // • Add an explicit type annotation to `pie` ->assigned as string
  ...
  // ======== Exercise 1.3 ========
  // Instructions:
  // • Inspect the error, then fix it. => added '=ture'
...
//Array<Array<number|string>>
  ...
  // later we destructure it (you dont need to mention due to the form I used :[string,number])
